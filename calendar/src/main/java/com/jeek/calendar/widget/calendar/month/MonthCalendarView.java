...
public class MonthCalendarView extends ViewPager implements OnMonthClickListener {
    ...
    private OnPageChangeListener mOnPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(final int position) {
            MonthViewAuto monthView = mMonthAdapter.getViews().get(getCurrentItem());
            if (monthView != null) {
    ...
    public void setTodayToView() {
        ...
        MonthViewAuto monthView = mMonthAdapter.getViews().get(mMonthAdapter.getMonthCount() / 2);
        if (monthView != null) {
    ...
    public SparseArray<MonthViewAuto> getMonthViews() {
        return mMonthAdapter.getViews();
    }

    public MonthViewAuto getCurrentMonthView() {
