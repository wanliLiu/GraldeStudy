 ...
 */
public class MonthViewAuto extends BaseCalendarView {
    ...
    public MonthViewAuto(Context context) {
        super(context);
    }

    public MonthViewAuto(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MonthViewAuto(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawNextMonth(Canvas canvas) {
        ...
        for (int day = 0; day < nextMonthDays; day++) {
            int column = (monthDays + dayoffset + day) % 7;
